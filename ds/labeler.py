"""
CurveLabeler for assigning analytic function labels to segmented time-series chunks.
...
class Labeler:
    ...
    def label(self, series: NDArray, breakpoints: list[int]) -> list[dict[str, Any]]:
        """
