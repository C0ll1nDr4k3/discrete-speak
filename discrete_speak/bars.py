...
class VolumeBar:
    ...
    def from_alpaca(
        ...
        """
        Volume bars are created by aggregating values until `volume_threshold` has been reached.
...
class DollarBar:
    ...
    def from_alpaca(
        ...
        """
        Dollar bars are created by aggregating values until `dollar_threshold` has been reached.
        ...
        for time_bar in time_bars:
            ...
            if running_dollar_volume == 0.0:  # First tick for this potential dollar bar
